<?php
/*
 * Template Name: Degree Search Template
*/
?>
    ...
    <div class="content-main-left">
    	<div class="content-main-left-inside">
            ...
            <div id="st-accordion" class="st-accordion">
                <ul>
                    <li>
                        <a href="#">SEARCH BY DEGREE LEVEL<span class="st-arrow">Open or Close</span></a>
                        <div class="st-content">
                        	<?php if ( !function_exists('dynamic_sidebar')
                                || !dynamic_sidebar('Search By Degree Level Content Widget') ) : ?>
                                <?php endif; ?>
                        </div>
                    </li>
		</ul>
            </div>
            <div id="sec-accordion" class="st-accordion">
                <ul>
                    <li>
                        <a href="#">SEARCH BY INTEREST<span class="st-arrow">Open or Close</span></a>
                        <div class="st-content">
                        	<?php if ( !function_exists('dynamic_sidebar')
                                || !dynamic_sidebar('Search By Interest Content Widget') ) : ?>
                                <?php endif; ?>
                        </div>
                    </li>
		</ul>
