...
function general_load_image_widget() {
	register_widget('general_Image_Widget');
}
add_action('widgets_init', 'general_load_image_widget');

/**
 * program_Image_Widget class
 **/
class general_Image_Widget extends WP_Widget {
	...
	function general_Image_Widget() {
		...
		$this->WP_Widget('widget_sp_image', __('General Post Widget', 'image_widget'), $widget_ops, $control_ops);
