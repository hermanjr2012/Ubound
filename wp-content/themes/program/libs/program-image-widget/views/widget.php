...
echo $before_widget;
echo '<li>';
if ( !empty( $title ) ) { echo '<a '. $lst .' href="'.$cust_url.'">' . $title . '<span class="st-arrow">Open or Close</span></a>'; }
echo '<div class="st-content">';
	...
	echo '<div class="section-right-main">';
		echo '<div class="padding-bottom">';
			echo '<b><em>Average Salary: ' . $avg_salary . '<br />Featured Job: '. $feat_job .'</b></em>';
		echo '</div>';
